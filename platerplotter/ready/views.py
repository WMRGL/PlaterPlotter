...
from ready.forms import Gel1008Form, SampleForm
...
def sample_comment_update(request, pk):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return redirect('ready:audit')
    else:
        form = SampleForm(instance=sample)
    return render(request, 'ready/update_sample.html', {'form': form, 'sample': sample})
